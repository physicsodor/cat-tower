...
function mathBlockHtml(kind: "math" | "dmath", latex: string): string {
  ...
  // For display math, wrap in an editable full-width inline container so the
  // browser can position the cursor before/after it (a bare contenteditable=false
  // block element swallows adjacent cursor positions).
